...
with open('./data/config.json','r',encoding='utf8') as config_file:
    config=json.load(config_file)
bot = commands.Bot(command_prefix= config['prefix'],owner_id=int(os.getenv("Owner")),intents=intents,strip_after_prefix=False)
